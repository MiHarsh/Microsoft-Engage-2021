...
function Le(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = qe(t, e.found.name), r = $e(e.found.updateTime), s = new jt({
            mapValue: {
...
async function Ze(t, e) {
    ...
    return (await n.P("RunQuery", r.parent, {
        ...
        const r = qe(t, e.name), s = $e(e.updateTime), i = new jt({
            mapValue: {
                fields: e.fields
            }
 ...
 */ class Cr {
    ...
    enqueue(t) {
        return this.kt(), this.qt ? new Promise((t => {})) : this.jt(t);
    }
    enqueueRetryable(t) {
...
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "2.3.8", "node");
