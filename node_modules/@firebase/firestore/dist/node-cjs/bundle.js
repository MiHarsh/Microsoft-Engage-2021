...
function loadBundle(data) {
    return database04501227.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    var _this = this;
    return database04501227.namedQuery(this._delegate, queryName).then(function (expQuery) {
        if (!expQuery) {
            return null;
        }
        return new database04501227.Query(_this, 
...
registerBundle(database04501227.Firestore);
